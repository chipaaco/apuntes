...
function initSearch() {
  ...
  request.open('GET', '/apuntes/sistemas-operativos/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/apuntes/sistemas-operativos/assets/css/just-the-docs-' + theme + '.css');
}
