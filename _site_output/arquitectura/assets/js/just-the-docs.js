...
function initSearch() {
  ...
  request.open('GET', '/apuntes/arquitectura/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/apuntes/arquitectura/assets/css/just-the-docs-' + theme + '.css');
}
